...
struct StoryBrain{
    ...
    mutating func nextSt(userChoice: String){
        let currentSt = story[storyNumber]
        if userChoice == currentSt.choice1{
            storyNumber = currentSt.choice1Destination
        }else{
            storyNumber = currentSt.choice2Destination
        }
    }
}
